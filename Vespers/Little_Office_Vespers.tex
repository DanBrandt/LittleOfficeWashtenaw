...
\rubric{\color{red} For `Advent', see page \underline{see page 14}.}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_109_1_vespers_3a}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_112_1_vespers_4A_STAR}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_121_1_vespers_3b}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_126_1_vespers_8G}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_147_1_vespers_4A_STAR}
...
\rubric{\color{red}All remain standing. The Cantor intones the antiphon. up to the asterisk (*) and then leads the Magnificat. The Magnificat antiphon is that of the Regina cæli during Paschal time.}
...
\rubric{\color{red}Proceed to page [] for the final Collect, Commemoration, and the Benedicamus.}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_109_1_vespers_8G}
	...
	\item  {\color{red}\textit{(rise)}} Sicut erat in princípio, et nunc, et \textbf{sem}per,~* et in sǽcula sæcu\textit{ló}\textit{rum}. \textbf{A}men.
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_112_1_vespers_1g}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_121_1_vespers_8G}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_126_1_vespers_1f}
...
\latinenglish{
	\gresetinitiallines{0}
	\gregorioscore{psalm_147_1_vespers_8G}
...
\rubric{\color{red}All remain standing. The Cantor intones the antiphon. up to the asterisk (*) and then leads the Magnificat.}
...
\latinenglish{
	...
	\item {\color{red}(rise)} Sicut erat in princípio, et nunc, et \textbf{sem}per,~* et in sǽcula sæcu\textit{ló}\textit{rum}. \textbf{A}men.
