...
\rubric{\color{red}Continue to the Conclusion on pg. [].}
...
\rubric{\color{red}See pg. [] for the Paschal Time variation of the Benedicamus. Otherwise the common tone is used:}
